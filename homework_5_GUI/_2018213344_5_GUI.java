...
public class _2018213344_5_GUI extends JFrame {
    ...
    private void setupUI() {
        ...
        _2018213344_5_Factory factory = new _2018213344_5_Factory();
     ...
     * 处理非菜单方式的事件
     */
    private void ActionHandler(_2018213344_5_Factory factory) {
        final String[] s = {""};
     ...
     * 菜单方式输入
     */
    private void MenuHandler(_2018213344_5_Factory factory) {
        GridBagConstraints gbc;
        final String[] s = {""};
        ...
        docMenu.addActionListener(event -> {
            if (Desktop.isDesktopSupported()) {
                try {
                    Desktop.getDesktop().open(new File(_2018213344_5_GUI.class.getResource("").getPath() + "/_2018213344_凌国瀚_5_帮助文档.pdf"));
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
     ...
     * @param type   员工类型
     */
    private void SetInfoEditable(_2018213344_5_GUI parent, String type) {
