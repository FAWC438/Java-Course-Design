...
public class GUI extends JFrame {
    ...
    private void setupUI() {
        ...
        Sale saleAction = new Sale(new ArrayList<>());
     ...
     * 处理事件
     */
    private void ActionHandler(Sale saleAction) {
        ...
        getBookConfirm().addActionListener(event -> {
            ...
            if (flag == 1) {
                if (getBookInfo()[4].getText() == null || getBookInfo()[4].getText().equals("")) {
                    ...
                    SaleLineItem newBooks = new SaleLineItem(
                            Integer.parseInt(getBookInfo()[3].getText()),
                            new ProductSpecification(getBookInfo()[1].getText(), Double.parseDouble(getBookInfo()[2].getText()),
                    ...
                    SaleLineItem newBooks = new SaleLineItem(
                            ...
                            new ProductSpecification(getBookInfo()[1].getText(),
